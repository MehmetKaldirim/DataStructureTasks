import java.util.*;
public class Task03_RomanNumberConverter {
    ...
    public static void main(String args[]){
        Task03_RomanNumberConverter ob = new Task03_RomanNumberConverter();

        String str = "MCMXLI";
        System.out.println("convert to the Decimal " + ob.romanToDecimal(str));

        System.out.println("convert to the Roman " + ob.decimalToRoman(1941));
    }
